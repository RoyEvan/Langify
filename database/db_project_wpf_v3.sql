...
CREATE TABLE `courses` (
  ...
  `COURSE_NAME` enum('English','Mandarin','Japanese','Spanish') NOT NULL,
  `COURSE_DESC` varchar(64) DEFAULT NULL,
  `COURSE_LEVEL` int(11) NOT NULL,
  `COURSE_CLASS` enum('A-101','A-102','A-103','A-104','A-105','A-106','A-107','A-108','A-109','A-201','A-202','A-203','A-204','A-205','A-206','A-207','A-208','A-209') NOT NULL,
...
CREATE TABLE `finished_assignments` (
  ...
  KEY `FK_STUDENT_ASSIGN` (`STUDENT_ID`),
